...
import { Matrix4, Quaternion, Vector3, Audio, AudioListener, AudioLoader } from 'three';
    ...
    <>
      <group ref={groupRef}>
        {props.planeType === 'vintage' ? (
          ...
          <group {...props} dispose={null} scale={0.01} rotation-y={Math.PI} rotation-x={Math.PI} rotation-z={Math.PI * 2 / 4 + Math.PI}>
            <mesh geometry={corsair.nodes.Cube001_Black_0.geometry} material={corsair.materials['Black']} />
            <mesh geometry={corsair.nodes.Cube001_Chassis_0.geometry} material={corsair.materials['Chassis']} />
            <mesh geometry={corsair.nodes.Cube001_Glass_0.geometry} material={corsair.materials['Glass']} ref={helixMeshRef} />
          </group>
        )}
      </group>
    </>
